...
res=g_model.invoke("what is the capital of india")
print(res.content)

structured_model = g_model.with_structured_output(EvaluationSchema)
...
def final_evaluation(state: UPSCState):
    ...
    overall_feedback = g_model.invoke(prompt).content
